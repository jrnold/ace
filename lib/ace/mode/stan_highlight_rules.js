...
define(function(require, exports, module) {
	...
	var keywords = "for|in|while|repeat|until|if|then|else|true|false|return";
	
	var storageType = "int|real|vector|simplex|unit_vector|ordered|" +
	    "positive_ordered|row_vector|" +
	    "matrix|cholesky_factor_cov|corr_matrix|cov_matrix|void";
	
	var builtinConstants = "lp__";
	
	var keywordMapper = this.createKeywordMapper({
	    "keyword": keywords + "|" + storageType,
